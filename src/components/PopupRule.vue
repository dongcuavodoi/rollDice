<template>
    <div class="wrapper-popup" v-bind:class="getClassPopup">
        <div class="rule">
            <h3>Luật chơi</h3>
            <p>Mỗi người chơi xoay 2 con xúc xắc để lấy điểm, điểm có được sẽ được lưu vào tổng điểm. Nếu xoay phải con xúc xắc số 1 sẽ mất lượt. Người chơi đạt được số điểm theo yêu cầu sẽ chiến thắng.</p>
            <button 
                v-on:click="confirm"
